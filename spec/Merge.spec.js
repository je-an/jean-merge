...
define([
    ...
    describe('Merge.spec.js', function () {
        ...
        describe("Merge", function () {
            it("TODO: Check if all members are available | EXPECTATION: Merge has all necessary members", function () {
                var numberOfMembers = 0;
                expect(Object.keys(instance).length).toEqual(numberOfMembers);
            });
            it("TODO: Check if all methods are available | EXPECTATION: Merge has all necessary methods", function () {
